...
const API_KEY = "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";
  ...
  return (
    <div className="App">
      <div style={{ position: "relative", height: "500px", width: "350px" }}>
        ...
        <button className="buttonStyle" style={{border: "0px", backgroundColor: "white"}} onClick={handleOnClick} ><Microphone/></button>
        </div>
      </div>
    </div>
  );
